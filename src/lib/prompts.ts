...
3. Always return valid JSON only, with no markdown fences or extra text
...
export function buildUserPrompt(productName: string, features: string, platform: string) {
